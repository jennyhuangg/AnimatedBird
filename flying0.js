...
window.onload = function init()
{
  ...
  // This allows us to use WebGL functions such as bindBuffer.
    ...
    var textureCoordAttribute = gl.getAttribLocation(shaderProgram, "vTexCoord");
    gl.enableVertexAttribArray(textureCoordAttribute);

    // Map the texture onto the cube's faces.
    var cubeVerticesTextureCoordBuffer = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, cubeVerticesTextureCoordBuffer);
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(flatten(verts)),
                gl.STATIC_DRAW);
